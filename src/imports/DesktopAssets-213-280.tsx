...
import svgPaths from "./svg-8vuhtdjh2u";
...
function DesktopAssetsBackgroundImageAndText({ text, additionalClassNames = "" }: DesktopAssetsBackgroundImageAndTextProps) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100", fontFamily: 'Saira, sans-serif' }} className={clsx("-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-light h-[15.675px] justify-center leading-[0] text-[10px] text-center text-white top-[20.57px] w-[36.58px]", additionalClassNames)}>
